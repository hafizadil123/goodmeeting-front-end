...
$("body").on("click",".row-hiw__nav-dots li",function(){
  let i = $(this).data('nav');
  let $tab = $(`.main-hiw__item[data-tab = "${  i  }"]`);
  let $img = $(`.content-imgs[data-img = "${  i  }"]`);
...
$('.bg .detail-form:nth-child(2)').css({
  'pointer-events': 'none',
  opacity: '0.5',
  opacity: '0.5',
});
$('.bg .detail-form:nth-child(3)').css({
  'pointer-events': 'none',
  opacity: '0.5',
});
$('.bg .detail-form:nth-child(4)').css({
  'pointer-events': 'none',
  opacity: '0.5',
});
$(function() {
...
$('.btn.btn-success.cont').click(function() {
  ...
  let set_time = $('#set_time')
    .find(':selected')
    .text();
  let future_date = $('#datepicker').val();
  let end_date = $('#datepicker2').val();
  let recurring = $('#recurring')
    .find(':selected')
    .text();
  let s = `${select_type  }, ${   future_date  }, ${  set_time   }, ${  recurring  }, ${  end_date}` ;
...
$(function() {
  ...
  let imagesPreview = function(input, placeToInsertImagePreview) {
    if (input.files) {
      ...
      let loopcount = (filesAmount > 3) ? 3 : filesAmount;
      let all = new Array();
      ...
      for (i = 0; i <= 2; i++) {
        ...
        reader.onload = function(event) {
          let tHtml = `<div class="alert thumb_uploaded  fade show">\
  ...
  $('.uploadImage').on('change', function() {
    $(".showImage").html('');
    let length = imagesPreview(this, '.showImage');
    // alert(length);
    let tHtml = '';
    if(length <= 3) {
      tHtml = '';
...
$('.successpop-trigger').click(function() {
  ...
  let delay = 3000; 
  let URL = 'scheduled-services.php';
...
$('.complete-prof .detail-form:nth-child(2)').css({
  'pointer-events': 'none',
  opacity: '0.5',
  opacity: '0.5',
});
$('.complete-prof .detail-form:nth-child(3)').css({
  'pointer-events': 'none',
  opacity: '0.5',
});
$('.complete-prof .detail-form:nth-child(4)').css({
  'pointer-events': 'none',
  opacity: '0.5',
});
