      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            <h1 className="heading1">Terms and Condition</h1>
...
<li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Good Meeting.</li>
<li>Country refers to: United Kingdom</li>
<li>Service refers to the Website.</li>
<li>Terms and Conditions (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement as been created with the help of <a href="https://www.termsfeed.com/terms-conditions-generator/">Terms and Conditions Generator</a>.</li>
...
<li>Website refers to Good Meeting, accessible from goodmeeting.today</li>
...
<ul>
<li>By email: info@goodmeeting.today</li>
</ul>
<p>&nbsp;</p>
            </div>
          </div>
