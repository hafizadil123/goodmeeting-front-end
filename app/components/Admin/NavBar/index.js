...
import { logoutAdmin } from '../../../utils/requests';
								...
								<li className="nav-item dropdown blur-ondrop">
									...
									>
										{profile && profile.avatar ? (
											...
											<img src={userImage} alt="user profile" className="serImageHeader" />
										)}
									</a>
                      ...
                      <li>
                        <a href="#">
                          <i className="mdi mdi-file-document-box" /> Billing
											...
											<li className="logout">
												<Link to="#" onClick={(e) => logoutAdmin(history)}>
									...
									<li>
										<a href="javascript:void(0)">
											...
											<span>
												...
												<img src="../assets/images/red-c.png" alt className="red-c" />{' '}
